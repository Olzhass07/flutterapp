...
class _PodcastsScreenState extends State<PodcastsScreen> {
  final List<Map<String, String>> _videos = [
    {'id': 'P26AE7NLx4Q', 'title': 'Learn English with PODCASTS — Why Tom Holland DELETED His Instagram'},
    {'id': '9EqrUK7ghho', 'title': 'The Stress Expert: Your Brain is Like a Phone Battery! (9 Ways to Instantly Recharge)'},
    {'id': 'oX7OduG1YmI', 'title': 'The Future Mark Zuckerberg Is Trying To Build'},
  ];
