...
class _DocumentariesScreenState extends State<DocumentariesScreen> {
  final List<Map<String, String>> _videos = [
    {'id': 'HnOzp8lo-IQ', 'title': 'The busiest cities in the world'},
    {'id': 'J_03EXyhYS8', 'title': 'Why can’t we stop eating certain foods?'},
    {'id': 'WSUj3PRvzzg', 'title': 'Is being bilingual good for your brain?'},
  ];
