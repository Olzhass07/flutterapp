...
class _MoviesScreenState extends State<MoviesScreen> {
  final List<Map<String, String>> _videos = [
    {'id': 'dH6NAYLLXuk', 'title': 'The best true story film that inspired thousands of people! | Full movie in English'},
    {'id': 'UUAENx1NANg', 'title': 'Learn English with Pirates Of The Caribbean'},
    {'id': 'pKoH9GkEKxQ', 'title': 'Learn English with Movies | Will Smith - The Pursuit of Happyness'},
  ];
